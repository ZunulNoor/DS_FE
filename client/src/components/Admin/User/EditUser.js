...
export const EditUser = () => {
  ...
  useEffect(() => {
    axios.get(`${AppRoute}api/get-user-by-id/${id}`)
      .then(json => {
  ...
  const handleSave = () => {
    axios.put(`${AppRoute}api/update-user/${id}`, formData)
      .then(json => {
      ...
      <div className="container-fluid" >
        <div className="row">
          <div className="col-md-12">
            <form method="put" id="" onSubmit={handleSave}>
                    ...
                    <div className="checkbox" style={{ display: 'flex', gap: '10px' }}>
                      <label>
                        <input
                          ...
                          checked={formData.project_file_add}
                      ...
                      <label>
                        <input
                          ...
                          checked={formData.project_file_edit}
                      ...
                      <label>
                        <input
                          ...
                          checked={formData.project_file_delete}
                    ...
                    <div className="checkbox" style={{ display: 'flex', gap: '10px' }}>
                      <label>
                        <input
                          ...
                          checked={formData.project_group_file_add}
                      ...
                      <label>
                        <input
                          ...
                          checked={formData.project_group_file_edit}
                      ...
                      <label>
                        <input
                          ...
                          checked={formData.project_group_file_delete}
                    ...
                    <div className="checkbox" style={{ display: 'flex', gap: '10px' }}>
                      ...
                      <label>
                        <input
                          type="checkbox"
                          name="voucher_delete"
                          checked={formData.voucher_delete}
                    ...
                    <div className="checkbox" style={{ display: 'flex', gap: '10px' }}>
                      <label>
                        <input
                          type="checkbox"
                          name="group_head_add"
                          checked={formData.group_head_add}
                      ...
                      <label>
                        <input
                          ...
                          checked={formData.group_head_edit}
                      ...
                      <label>
                        <input
                          ...
                          checked={formData.group_head_delete}
                    ...
                    <div className="checkbox" style={{ display: 'flex', gap: '10px' }}>
                      ...
                      <label>
                        <input
                          type="checkbox"
                          name="sub_head_edit"
                          checked={formData.sub_head_edit}
                      ...
                      <label>
                        <input
                          ...
                          checked={formData.sub_head_delete}
